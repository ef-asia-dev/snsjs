...
$sns = {
	...
	site: {
		...
		getTitle: function(){return jQuery('title:last').text();},
		getDesc: function(){return jQuery('meta[property="og:description"]:last').attr('content');},
		getImage: function(){return jQuery('meta[property="og:image"]:last').attr('content');},
		links:{
			whatsapp: "", 
			facebook: "",
			twitter: "",
	...
	bindLink: function(){
		...
		jQuery.each(this.settings.selectors.sns, function(key, value) {
			...
			//console.log(sel);
			jQuery(sel).attr('href', _this['site']['links'][key] );
		});	
		...
		jQuery.each(this.settings.selectors.sns, function(key, value) {
			...
			//console.log(sel);
			jQuery(sel).attr('href', _this['result']['links'][key] );
		});		
	...
	hideElement : function(){
		...
		if (_this.isMicromessenger()) {
			...
			jQuery.each(this.settings.selectors.sns, function(key, value) {
				if( key != 'wechat'){
					//jQuery(_this['settings']['selectors']['sns'][key]).hide();
					_this.cssHide(_this['settings']['selectors']['sns'][key]);
				}
			});
		}
